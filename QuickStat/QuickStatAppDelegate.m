...
#import "QuickStatAppDelegate.h"

@implementation QuickStatAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"QuickStat" withExtension:@"momd"];
